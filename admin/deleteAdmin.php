<?php
    ...
    if(!isset($_SESSION['login']))
    {
     ...
     { 
         ...
         $delete->execute([$id]);
         $delete->closeCursor();
         header("LOCATION:admin.php?delete=success&id=".$id);
     }
...
<div class="container">
    ...
    <a href="admin.php" class="btn btn-success mx-2">Non</a>
    <a href="deleteAdmin.php?id=<?= $don['id'] ?>&del=ok" class="btn btn-danger mx-2">Oui</a>
