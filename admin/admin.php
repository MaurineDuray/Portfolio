<?php
    ...
    unset($_SESSION['errorAddAdmin']); // unset détruit une variable
...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-12">
            ...
            <a href="addAdmin.php" class="btn btn-success my-1">Ajouter un administrateur</a>
        </div>
    </div>
</div>
<div class="container">
                    ...
                    while($don = $req->fetch())
                    {
                        echo "<tr>";
                            ...
                            echo "<td class='text-center'>";
                                echo "<a href='updateAdmin.php?id=".$don['id']."' class='btn btn-warning mx-2'>Modifier</a>";
                                echo "<a href='deleteAdmin.php?id=".$don['id']."' class='btn btn-danger mx-2'>Supprimer</a>";
                            echo "</td>";
                        echo "</tr>";
                    }
                    $req->closeCursor();
